...
class MvpSurveySurveyActivity : BaseActivity(), View.OnClickListener, OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
  ...
  lateinit var current_point: EditText
  lateinit var mvp_survey_survey_gps_data_antenna_height: Button
  lateinit var mvp_survey_survey_file_description: Button
  lateinit var mvp_survey_survey_back: Button
  lateinit var mvp_survey_survey_settings: Button
  lateinit var mvp_survey_point: Button
  lateinit var no_survey_favorite_labels: TextView
  lateinit var mvp_survey_survey_gps_data_acc: TextView
  lateinit var mvp_survey_survey_gps_data_lat: TextView
  lateinit var mvp_survey_survey_gps_data_long: TextView
  lateinit var mvp_survey_survey_gps_data_alt: TextView
  lateinit var mvp_survey_survey_gps_data_speed: TextView
  lateinit var mvp_survey_survey_gps_data_bearing: TextView
  lateinit var mvp_survey_survey_gps_data_time: TextView
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    mvp_survey_survey_gps_data_antenna_height = findViewById(R.id.mvp_survey_survey_gps_data_antenna_height)
    mvp_survey_survey_file_description = findViewById(R.id.mvp_survey_survey_file_description)
    mvp_survey_survey_back = findViewById(R.id.mvp_survey_survey_back)
    mvp_survey_survey_settings = findViewById(R.id.mvp_survey_survey_settings)
    mvp_survey_point = findViewById(R.id.mvp_survey_point)
    no_survey_favorite_labels = findViewById(R.id.no_survey_favorite_labels)
    mvp_survey_survey_gps_data_acc = findViewById(R.id.mvp_survey_survey_gps_data_acc)
    mvp_survey_survey_gps_data_lat = findViewById(R.id.mvp_survey_survey_gps_data_lat)
    mvp_survey_survey_gps_data_long = findViewById(R.id.mvp_survey_survey_gps_data_long)
    mvp_survey_survey_gps_data_alt = findViewById(R.id.mvp_survey_survey_gps_data_alt)
    mvp_survey_survey_gps_data_speed = findViewById(R.id.mvp_survey_survey_gps_data_speed)
    mvp_survey_survey_gps_data_bearing = findViewById(R.id.mvp_survey_survey_gps_data_bearing)
    mvp_survey_survey_gps_data_time = findViewById(R.id.mvp_survey_survey_gps_data_time)
