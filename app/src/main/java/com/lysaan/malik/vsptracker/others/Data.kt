...
class Data : Serializable {
    ...
    override fun toString(): String {
        return "Data(recordID='$recordID', isUnload=$isUnload, isStartMachine=$isStartMachine, isRepeatJourney=$isRepeatJourney, isForLoadResult=$isForLoadResult, isForUnloadResult=$isForUnloadResult, machineType=$machineType, loadingMachine='$loadingMachine', loadingMaterial='$loadingMaterial', loadingLocation='$loadingLocation', unloadingTask='$unloadingTask', unloadingMachine='$unloadingMachine', unloadingMaterial='$unloadingMaterial', unloadingLocation='$unloadingLocation', loadedWeight=$loadedWeight, loadedMachine='$loadedMachine', time='$time', date='$date', eWorkType=$eWorkType, eWorkActionType=$eWorkActionType, workMode='$workMode')"
    }
