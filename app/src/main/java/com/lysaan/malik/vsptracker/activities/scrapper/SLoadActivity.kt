...
//                }
    ...
    private fun selectMaterial() {
        ...
        sload_material_spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
    ...
    private fun selectLocation() {
        ...
        sload_location_spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
