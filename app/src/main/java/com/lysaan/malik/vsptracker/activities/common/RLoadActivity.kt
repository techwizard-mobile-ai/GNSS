...
//        }
        ...
        trload_machine.text = "1. " +lastJourney.loadingMachine
        trload_material.text = "2. " +lastJourney.loadingMaterial
        trload_location.text = "3. " +lastJourney.loadingLocation
        trload_weight.text = "4. Tons (" +lastJourney.loadedWeight +")"
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, intent: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if(bundle != null){
                ...
                trload_machine.text = "1. " +data.loadingMachine
                trload_material.text = "2. " +data.loadingMaterial
                trload_location.text = "3. " +data.loadingLocation
                trload_weight.text = "4. Ton (" +data.loadedWeight +")"
